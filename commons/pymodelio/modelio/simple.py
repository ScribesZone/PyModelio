...
# noinspection PyUnresolvedReferences
from org.modelio.metamodel.analyst import AnalystProject as IAnalystProject
# noinspection PyUnresolvedReferences
from org.modelio.metamodel.mda  import Project as IProject
# noinspection PyUnresolvedReferences
from org.modelio.metamodel.mda  import ModuleComponent as IModuleComponent
...
def theAnalystProject():
  ...
  """
  for root in theSession().getModel().getModelRoots():
    if isinstance(root, IAnalystProject):
      return root
...
def theLocalModule():
  ...
  """
  for root in theSession().getModel().getModelRoots():
    if isinstance(root, IModuleComponent):
      return root
...
def setSelection(elementOrElements):
  ...
  """
  Modelio.getInstance().getNavigationService()\
      .fireNavigate(list(elementOrElements))
