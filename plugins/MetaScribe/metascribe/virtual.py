...
def registerVirtualMetaFeatures():
    introspection.VirtualRegistry.add(
        introspection.VirtualMetaFeature(getDisplayingDiagrams,ModelioElement,                                              'getDisplayingDiagrams',ModelioAbstractDiagram,True))
    introspection.VirtualRegistry.add(
        introspection.VirtualMetaFeature(getDiagramGraphics,ModelioElement,
                           'getDiagramGraphics',IDiagramGraphic,True))
    introspection.VirtualRegistry.add(
        introspection.VirtualMetaFeature(getDiagramNode,ModelioAbstractDiagram,
